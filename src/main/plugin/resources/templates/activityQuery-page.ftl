...
<p>
    ...
    <br>
    <br>
    To view the schema of the activity database, follow this <a
        href=<@s.text name="dbQuery.link.database.activity" /> target="_blank" title="Jive 5.0 Activity Engine Database
    Schema">link</a>.
    <br>
    <br>
<#if !selectQuery>
